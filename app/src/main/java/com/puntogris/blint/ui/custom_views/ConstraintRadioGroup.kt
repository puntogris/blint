...
class ConstraintRadioGroup : ConstraintLayout {
    /**
     *
    ...
    constructor(context: Context, attrs: AttributeSet?) : super(context, attrs) {
        ...
        val value = attributes.getResourceId(R.styleable.ConstraintRadioGroup_checkedButton2, NO_ID)
        if (value != NO_ID) {
    ...
    override fun getAccessibilityClassName(): CharSequence {
        return ConstraintRadioGroup::class.java.name
    }
    ...
    interface OnCheckedChangeListener {
         ...
         */
        fun onCheckedChanged(group: ConstraintRadioGroup?, @IdRes checkedId: Int)
    }
    ...
    private inner class PassThroughHierarchyChangeListener :
        ...
        override fun onChildViewAdded(parent: View, child: View) {
            if (parent === this@ConstraintRadioGroup && child is RadioButton) {
                var id = child.getId()
    ...
    companion object {
        private val LOG_TAG = ConstraintRadioGroup::class.java.simpleName
    }
}