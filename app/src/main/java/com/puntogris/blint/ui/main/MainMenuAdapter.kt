...
class MainMenuAdapter(private val clickListener: (MenuCard) -> Unit) : ListAdapter<MenuCard, RecyclerView.ViewHolder>(MenuCardDiffCallback()) {
    ...
    init {
        val list = listOf(
            ...
            MenuCard(R.string.managment, 0,0),
